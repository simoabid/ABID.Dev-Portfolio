  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 bg-[var(--color-background)]">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_40%,var(--color-accent-muted),transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_60%,rgba(0,212,255,0.08),transparent_50%)]" />
      </div>

      {/* Content */}
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-[var(--color-foreground)] mb-4 animate-fade-in">
        ...
        <p className="text-lg md:text-xl text-[var(--color-foreground-muted)] mb-10 max-w-2xl mx-auto animate-slide-up">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-32 overflow-hidden">
        ...
        >
          <path
            ...
            className="fill-[var(--color-background-alt)] opacity-30"
          />
        </svg>
      </div>
    </section>
