        ...
        <Grid cols={1} colsMd={2} colsLg={3} gap={8}>
          {placeholderProjects.map((project) => (
            <GridItem key={project.id}>
              <div className="h-full bg-[var(--color-background)]/80 rounded-xl overflow-hidden border border-[var(--color-border-muted)] hover:border-[var(--color-border-accent)] transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-[var(--color-shadow-accent)] group">
