...
interface LogoLoopProps {
  ...
  gap?: number;
  /** @deprecated Use `hoverSpeed` instead. */
  pauseOnHover?: boolean;
  /** Speed when hovering. Set to 0 to pause, or a lower value for deceleration. */
  hoverSpeed?: number;
  /** Whether to apply fade-out effect at the edges. */
  fadeOut?: boolean;
  /** Color used for the fade-out effect. */
  fadeOutColor?: string;
